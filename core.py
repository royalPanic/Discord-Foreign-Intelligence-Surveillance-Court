...
bot = commands.Bot( #the actual bot initialization arguments
    ...
    description = "A simple bot designed to pay very special attention to users.",
...
@bot.event
async def on_ready():
    print("DiscordFISA is operational!")
...
async def shutdown(ctx):
    ...
    e = discord.Embed(colour=discord.Colour(0x57F287), description="Command Received, Shutting down DiscordFISA!")
    await ctx.send(embed=e)
    exit()
